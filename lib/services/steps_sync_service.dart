...
// /// Reads steps from Health Connect periodically and syncs to backend.
// /// Call [start] once when the app opens. Call [dispose] when done.
...
//   /// Start periodic sync. Also runs immediately on call.
//   void start() {
//     _syncNow();                          // run immediately on app open
//     _timer = Timer.periodic(_interval, (_) => _syncNow());
//   }

//   /// Trigger a manual sync (e.g. when user pulls to refresh).
//   Future<void> syncNow() => _syncNow();

//   Future<void> _syncNow() async {
//     if (_syncing) return;               // prevent overlapping calls
//     _syncing = true;
//     try {
...
//       }
//     } catch (_) {
//       // Silent — never crash the app over a sync failure
//     } finally {
//       _syncing = false;
//     }
//   }
