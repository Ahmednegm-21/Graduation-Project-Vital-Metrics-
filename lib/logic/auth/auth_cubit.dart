...
class AuthCubit extends Cubit<AuthState> {
  ...
  // 2. لو نجح مباشرة → AuthSuccess
  // 3. لو أول مرة (needsProfile) → AuthGoogleNeedsProfile
  //    وفي الـ screen هيفتح bottom sheet يطلب البيانات
  //    ويستدعي completeGoogleSignIn
  ...
  // ── Complete Google Sign In (أول مرة — ابعت البيانات) ─────────────────────
