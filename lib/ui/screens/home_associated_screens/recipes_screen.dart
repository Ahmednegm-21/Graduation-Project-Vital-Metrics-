...
class _RecipesScreenState extends State<RecipesScreen>
  ...
  void _addSelected() {
    for (final id in _chosen) {
      final r = Recipe.sampleRecipes.firstWhere((r) => r.id == id);
    ...
    final total = _chosen.fold(0, (s, id) {
      final r = Recipe.sampleRecipes.firstWhere((r) => r.id == id);
      return s + _kcal(r);
    });
                ...
                return GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    child: Text(
                      f.toUpperCase(),
                      style: TextStyle(
                        color: sel ? Colors.white : context.colors.subText,
                        fontWeight: FontWeight.bold,
                        fontSize: 12,
                      ),
                    ),
...
// ══════════════════════════════════════════════════════════════════════════════
// _RecipeTile — StatefulWidget مع entrance animation + serving control
// ══════════════════════════════════════════════════════════════════════════════
...
class _RecipeTileState extends State<_RecipeTile>
            ...
            child: AnimatedContainer(
              ...
              child: Column(
                children: [
                  ...
                  // ── Macros strip — يظهر لما الـ serving يتغير ────────
                  AnimatedSize(
                    duration: const Duration(milliseconds: 280),
                    curve: Curves.easeOutCubic,
  ...
  String _servingLabel() {
    ...
    // حاول تستخرج الرقم الأصلي وتضربه
...
// ══════════════════════════════════════════════════════════════════════════════
// _MacrosStrip — شريط صغير بالـ macros يظهر لما الـ serving يتغير
// ══════════════════════════════════════════════════════════════════════════════
...
// ══════════════════════════════════════════════════════════════════════════════
// _ServingSheet — bottom sheet لتغيير الحصة بدقة
// ══════════════════════════════════════════════════════════════════════════════
...
// ══════════════════════════════════════════════════════════════════════════════
// _BellAction — shared bell button
// ══════════════════════════════════════════════════════════════════════════════
