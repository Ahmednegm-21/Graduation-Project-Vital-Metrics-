            ...
            builder: (context, water) => SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  FadeInDown(delay: const Duration(milliseconds: 80), child: _WeeklyGoalGraph(cal: cal)),
                  const SizedBox(height: 16),
                  FadeInDown(delay: const Duration(milliseconds: 130), child: _SectionTitle(title: 'Body Stats')),
                  FadeInDown(
...
// ══════════════════════════════════════════════════════════════════════════════
// _BellButton — مشترك بين كل الصفحات
// ══════════════════════════════════════════════════════════════════════════════
class _BellButton extends StatelessWidget {
  final bool isDark;
  const _BellButton({required this.isDark});

  // عدد ثابت للتوضيح — في التطبيق الحقيقي يجي من cubit
...
class _WeeklyGoalGraph extends StatelessWidget {
  ...
  static const _consumed = [2100, 2800, 1950, 3100, 2600, 2200, 0];
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: context.colors.shadow, blurRadius: 16, offset: const Offset(0, 6))],
      ),
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text('Weekly Goal', style: TextStyle(color: context.colors.text, fontWeight: FontWeight.bold, fontSize: 15)),
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                decoration: BoxDecoration(color: const Color(0xFF4361EE).withOpacity(0.12), borderRadius: BorderRadius.circular(10)),
                child: const Text('Goal: $_goal kcal', style: TextStyle(color: Color(0xFF4361EE), fontWeight: FontWeight.bold, fontSize: 11)),
              ),
            ],
          ),
          const SizedBox(height: 20),
            ...
            child: Row(
              ...
              children: List.generate(7, (i) {
                ...
                final barColor = overGoal
                    ...
                    : isToday ? const Color(0xFF4361EE) : const Color(0xFF4361EE).withOpacity(0.4);
                          ...
                          Padding(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(fontSize: 9, fontWeight: FontWeight.bold,
                                  color: isToday ? const Color(0xFF4361EE) : context.colors.subText),
                            ),
                          ),
                        Stack(
                          ...
                          children: [
                            Container(height: 100, decoration: BoxDecoration(
                                color: context.isDark ? Colors.white10 : const Color(0xFFF0F0F8),
                                borderRadius: BorderRadius.circular(8))),
                            Positioned(bottom: 100 * 1.0, left: 0, right: 0,
                                child: Container(height: 1.5, color: const Color(0xFFFF8787).withOpacity(0.5))),
                            AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                color: barColor,
                                borderRadius: BorderRadius.circular(8),
                                boxShadow: isToday ? [BoxShadow(color: const Color(0xFF4361EE).withOpacity(0.4), blurRadius: 8, offset: const Offset(0, 3))] : [],
                              ),
                            ),
                          ],
                        ),
...
class _LegendDot extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(children: [
    ...
    Text(label, style: TextStyle(color: context.colors.subText, fontSize: 10)),
  ]);
}
...
class _BmiCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(colors: [Color(0xFF4361EE), Color(0xFF7B5EA7)], begin: Alignment.topLeft, end: Alignment.bottomRight),
        borderRadius: BorderRadius.circular(24),
        boxShadow: [BoxShadow(color: const Color(0xFF4361EE).withOpacity(0.35), blurRadius: 20, offset: const Offset(0, 8))],
      ),
      child: Column(children: [
        Row(children: [
          SizedBox(width: 90, height: 90,
            child: Stack(alignment: Alignment.center, children: [
              ...
              Column(mainAxisSize: MainAxisSize.min, children: [
                Text(bmi.toStringAsFixed(1), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 22)),
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Container(
              ...
              decoration: BoxDecoration(color: _bmiColor.withOpacity(0.25), borderRadius: BorderRadius.circular(20)),
              child: Text(info.bmiCategory, style: TextStyle(color: _bmiColor, fontWeight: FontWeight.bold, fontSize: 14)),
            ),
        ...
        Container(
          ...
          child: Row(children: [
            ...
            const SizedBox(width: 8),
            const Expanded(child: Text('BMI calculated from your weight & height in Personal Information', style: TextStyle(color: Colors.white70, fontSize: 11))),
            GestureDetector(
              onTap: () => context.push('/settings'),
              child: const Text('Update →', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 11)),
            ),
          ]),
        ),
      ]),
...
class _SectionTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Align(
    ...
    child: Padding(
      ...
      child: Text(title, style: TextStyle(color: context.colors.text, fontWeight: FontWeight.bold, fontSize: 15)),
    ),
  );
}
    ...
    return Container(
      ...
      child: Column(children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Text('Calories', style: TextStyle(color: context.colors.text, fontWeight: FontWeight.bold, fontSize: 14)),
          Container(
            padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
            decoration: BoxDecoration(color: const Color(0xFF4361EE).withOpacity(0.12), borderRadius: BorderRadius.circular(10)),
...
class _WaterProgressCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Text('Water Intake', style: TextStyle(color: context.colors.text, fontWeight: FontWeight.bold, fontSize: 14)),
          Container(
            padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
            decoration: BoxDecoration(color: Colors.blue.withOpacity(0.12), borderRadius: BorderRadius.circular(10)),
            child: Text('${water.consumedInUnit.toStringAsFixed(0)} / ${water.goalInUnit.toStringAsFixed(0)} ${water.unit}',
            ...
            child: Column(children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Row(children: [
                  ...
                  const SizedBox(width: 8),
                  Text(m['label'] as String, style: TextStyle(color: context.colors.text, fontWeight: FontWeight.w600, fontSize: 13)),
                ]),
                Text('$consumed / ${goal}g', style: TextStyle(color: context.colors.subText, fontSize: 12)),
              ]),
              const SizedBox(height: 6),
