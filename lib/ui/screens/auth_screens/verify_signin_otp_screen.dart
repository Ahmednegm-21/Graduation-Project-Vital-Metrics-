...
class VerifySigninOtpScreen extends StatefulWidget {
  final String email;
  const VerifySigninOtpScreen({super.key, required this.email});

  @override
  State<VerifySigninOtpScreen> createState() => _VerifySigninOtpScreenState();
}

class _VerifySigninOtpScreenState extends State<VerifySigninOtpScreen> {
  ...
  void _showResendInfo() {
    _showSnack(
      'To get a new code, go back and sign in again',
