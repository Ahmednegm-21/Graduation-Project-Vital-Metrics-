...
//     enableDrag: true,       // ✅ يسمح بالسحب لتحت
//     isDismissible: true,    // ✅ يقفل لما يدوس برا
...
//                     children: [
//                       // ✅ Handle مع GestureDetector للسحب
//                       GestureDetector(
//                         onVerticalDragEnd: (details) {
//                           if (details.primaryVelocity != null &&
...
//         _MacroData('Calories', orig.calories, alt.calories, 'kcal',
//             Colors.orange),
//         _MacroData('Protein', orig.protein, alt.protein, 'g',
//             const Color(0xFF4361EE)),
//         _MacroData('Carbs', orig.carbs, alt.carbs, 'g',
//             const Color(0xFF34C759)),
//         _MacroData('Fats', orig.fats, alt.fats, 'g', Colors.purple),
//         _MacroData('Fiber', orig.fiber, alt.fiber, 'g',
...
//   final String label;
//   const _FoodHeader(
//       {required this.food, required this.gradient, required this.label});
...
//     final higherIsBetter = label == 'Protein' || label == 'Fiber';
//     final altWins = higherIsBetter
//         ? altValue > origValue
//         : altValue < origValue;
...
//           SizedBox(height: 8.h),
//           _BarRow(
//               label: 'Original', value: origValue, unit: unit,
//               fraction: origFrac, color: color.withOpacity(0.5),
//               isDark: isDark),
//           SizedBox(height: 5.h),
//           _BarRow(
//               label: 'Alt', value: altValue, unit: unit,
//               fraction: altFrac, color: altGradient[0],
//               isDark: isDark, isAlt: true),
//         ],
//       ),
//     );
//   }
...
//     }
//     if (alternative.fiber > original.fiber + 1) {
//       wins.add('🌿 +${(alternative.fiber - original.fiber).round()}g fiber');
//     }
...
//           Expanded(
//             child: Text(
//                 'Both foods have a similar nutritional profile.',
//                 style: TextStyle(
...
class _CompareSheetState extends State<_CompareSheet>
  ...
  Widget build(BuildContext context) {
    ...
    // DraggableScrollableSheet يحل مشكلة السحب مع الـ scroll
        ...
        child: ClipRRect(
          ...
          child: BackdropFilter(
            ...
            child: Container(
              ...
              child: ListView(
                controller: scrollCtrl, // ✅ ربط الـ scroll بالـ drag
                padding: EdgeInsets.fromLTRB(
                    20.w, 12.h, 20.w,
                    MediaQuery.of(context).padding.bottom + 24.h),
                children: [
