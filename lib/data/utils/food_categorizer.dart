// Single source of truth for guessing a food's emoji and category from
// its (Arabic or English) name. Used by Recipe.fromMealModel and by
// FoodSwapService, so the logic only lives in ONE place — edit here only.

/// Returns a representative emoji for a food/meal name (Arabic or English).
...
/// Returns a category ('breakfast' | 'lunch' | 'dinner' | 'snacks')
/// for a food/meal name (Arabic or English).
